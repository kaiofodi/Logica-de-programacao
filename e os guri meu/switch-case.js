...
// → Seu código aqui:
/*
const turnos = lerTeclado.questionInt('Escolha um turno 1. manha | 2. tarde | 3. noite: ')
...
// → Seu código aqui:
/*
let estacao = lerTeclado.question('Diga a sua estacao favorita: ')
...
// → Seu código aqui:
/*
let DiaSemana = lerTeclado.questionInt('Escolha um numero de 1 a 7: ')
...
const produto = {
    ...
    descricaoCategoria: lerTeclado.questionInt('Diga um numero 1. Eletronico | 2. Vestuario | 3. Alimento | 4. Livro: '),
    preco: lerTeclado.questionFloat('Diga o seu preco: ')
}

switch(produto.descricaoCategoria){
    case 1:
        console.log(`${produto.descricaoCategoria}: "Eletronico" e garantia de "12 meses".`)
        break;
    case 2:
        console.log(`${produto.descricaoCategoria}: "Vestuario" e garantia: "Troca em 30 dias".`)
        break;
    case 3:
        console.log(`${produto.descricaoCategoria}: "Alimento" e garantia: "Ver validade".`)
        break;
    case 4:
        console.log(`${produto.descricaoCategoria}: "Livro" e garantia: "Sem garantia".`)
        break;
    default:
        console.log(`${produto.descricaoCategoria}: "Categoria Invalida" e garantia: "Sem garantia".`)
}
...
const user = {
    ...
    nota:lerTeclado.questionInt('Diga uma nota de 0 a 10: ')
}
...
switch(user.nota){
    ...
    case 7:
        ...
        break;
    case 6:
        console.log('C, Suficiente.')
        break;
    case 5:
        console.log('C, Suficiente.')
        break;
    case 4:
        console.log('D, Em recuperacao.')
        break;
    case 3:
        console.log('D, Em recuperacao.')
        break;
...
console.log(`${user.nome} - Nota: ${user.nota}.`)
*/
console.log("_______________________________");
...
const loja = {
    nome: 'TechShop',
    saldo: 0,
    menu: lerTeclado.questionInt('Selecione 1. Ver produtos | 2. Comprar | 3. Ver carrinho | 4. Sair:  ')
}
