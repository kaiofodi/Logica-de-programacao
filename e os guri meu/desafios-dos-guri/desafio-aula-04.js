...
const carrinho = {
    produtoUsuario: lerTeclado.question('Escolha 03 itens: '),
    precoUsuario: lerTeclado.questionFloat('Diga o preco deles: '),

produtoDois: {
    produtoUsuario2: lerTeclado.question('Escolha 03 itens: '),
    precoUsuario2: lerTeclado.questionFloat('Diga o preco deles: '),
},

produtoTres: {
    produtoUsuario3: lerTeclado.question('Escolha 03 itens: '),
    precoUsuario3: lerTeclado.questionFloat('Diga o preco deles: ')
    },
}
valorTotal = (carrinho.precoUsuario + carrinho.produtoDois.precoUsuario2 + carrinho.produtoTres.precoUsuario3)
valorMedio = valorTotal / 3;
console.table(carrinho);
console.log(`Valor total: R$ ${valorTotal}
Valor medio: R$ ${valorMedio}`);
*/
...
const despesas = {
    aluguel: lerTeclado.questionFloat('Diga o quanto paga de aluguel: '),
    internet: lerTeclado.questionFloat('Diga o quanto paga de internet: '),
    energia: lerTeclado.questionFloat('Diga o quanto paga de energia: '),
    alimentacao: lerTeclado.questionFloat('Diga o quanto paga de alimentacao: ') 
}

totalDespesas = (despesas.aluguel + despesas.internet + despesas.energia + despesas.alimentacao)
mediaDespesas = totalDespesas / 4

let sobraSalario = salario - totalDespesas

console.log(`Total de despesas: ${totalDespesas}
 Média de despesas: ${mediaDespesas}
 Dinheiro restante: ${sobraSalario}`);
*/
...
/*
const jogador = {
    nomeJogador: lerTeclado.question('Diga seu nome: '),
    partidasJogadas: lerTeclado.questionInt('Quantas partidas jogou: '),
    gols: lerTeclado.questionInt('Quantos gols fez: '),
    assistencias: lerTeclado.questionInt('Quantas assistencias fez: ')
}
...
Participações em gol: ${jogador.gols}
