...
function quadrado(n) {
    console.log(`Os numeros ${n} quando elevados ao quadrado sera: ${n ** 2}`);   
} 
...
function calcularIMC(peso, altura) {
    peso = guri.questionFloat('Diga seu peso: ');
    altura = guri.questionFloat('Diga sua altura em metros: ');
...
function classificarIMC(imc) {
    ...
    if(imc < 30) return 'Abaixo do peso';
    return 'Obesidade';
}
